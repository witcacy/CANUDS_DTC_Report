...
//  Last changed date:  $Date: 2025-06-23 17:05:12 +0200 (Mon, 23 Jun 2025) $
//
//  Language: C#
//  ------------------------------------------------------------------
//
...
namespace Peak.Can.IsoTp
{
    ...
    public enum cantp_parameter : UInt32
    {
        ...
        /// <summary>
        /// 1 BYTE data stating if the allow-list CAN IDs filtering mechanism is enabled.
        /// </summary>
        ...
        /// <summary>
        /// 1 BYTE data describing the minimum time between a First Frame and a Flow Control (see STmin for values).
        /// </summary>
        PCANTP_PARAMETER_SEPARATION_TIME_FC_TX = 0x127,
    ...
    public static partial class CanTpApi
    {
        ...
        /// <summary>
        /// CAN ID will be initialized through ISOTP networking address information.
        /// </summary>
        public const UInt32 PCANTP_CAN_ID_DEFINED_BY_NAI = 0xFFFFFFFF;
        #endregion
        ...
        /// <summary>
        /// Adds an entry to the CAN-ID allow-list filtering.
        /// </summary>
        /// <param name="channel">A PCANTP Channel Handle representing a PCANTP-Client</param>
        ...
        /// <summary>
        /// Removes an entry from the CAN-ID allow-list filtering.
        /// </summary>
        /// <param name="channel">A PCANTP Channel Handle representing a PCANTP-Client</param>
